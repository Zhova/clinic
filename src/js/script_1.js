$(document).ready(function () {
  ...
  $(
    ".doc-screen .specialists-slider, .single-service .specialists-slider"
  ).slick({
    slidesToShow: 3,
    slidesToScroll: 1,
    nextArrow:
  ...
  $(".popularDest-slider, .specialists-slider")
  ...
  $(".btn-lines_red").before(
    '<div class="btn-line btn-line_red btn-line_before"></div>'
  );
  $(".btn-lines_red").after(
    '<div class="btn-line btn-line_red btn-line_after"></div>'
  );
